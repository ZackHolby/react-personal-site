                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 offset-lg-0 col-md-6 offset-md-0 col-sm-10 offset-sm-1 col-10 offset-1">
                            <a href="https://cryptoment.azurewebsites.net/" class="custom-card">
                                <Card pic={CryptoImg} title="Crypto Sentiment Webapp" text="Created a Cryptocurrency web app to pull crypto data and analyze sentiment from Twitter. Used Blazor server with C#/.NET 5.0 for development with use of Azure functions, cloud database, and app service for deployment with Docker. Created custom Flask API for twitter scraping."></Card>
                            </a>
                        </div>
                        <div class="col-lg-4 offset-lg-0 col-md-6 offset-md-0 col-sm-10 offset-sm-1 col-10 offset-1">
                            <a href="https://webappscseproject.herokuapp.com/" class="custom-card">
